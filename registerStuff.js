<!-- <div className="signup__container">
  <div className="container__child signup__thumbnail">
    <div className="thumbnail__logo">
      <svg className="logo__shape" width="25px" viewBox="0 0 634 479" xmlns="http://www.w3.org/2000/svg">
        <g>
    ...
    <div className="thumbnail__content text-center">
      ...
      <h2 className="heading--secondary">We'll be your bottom hoe everyday of the week, ready daddy?</h2>
    </div>
...
<TextFieldGroup id="username" placeholder="Username" label="Username" name="username" type="text" value={this.state.username}
  onChange={this.onChange} error={errors.username} />
<TextFieldGroup id="email" placeholder="Email" label="Email" name="email" type="email" value={this.state.email}
  onChange={this.onChange} error={errors.email} />
<TextFieldGroup id="password" placeholder="********" label="Password" name="password" type="password" value={this.state.password}
  onChange={this.onChange} error={errors.password} />
<TextFieldGroup id="passwordRepeat" placeholder="********" label="Repeat Password" name="password2" type="password"
